...
keeping_loop            call    #sub_peek        'Wert aus Ram lesen
                ...
                if_z    jmp     #cog_keepout     'dann raus
                        add     _ftemp,#1        'Adresse erhöhen (als Rückgabewert gebraucht)
...
loop_copy               call    #sub_peekadr
                        ...
                        add     _ftemp,#1        'Quelladresse erhöhen und nach _adr zurückschreiben
                        mov     _adr,_ftemp
...
cog_read
              ...
              if_z      jmp     #cog_subpeek
                        mov     _REGB,_tmp        'bisheriger Wert nach REGB

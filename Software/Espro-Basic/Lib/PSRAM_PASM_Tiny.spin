...
cog_loop                rdlong  _job,par wz     ' get job id
              ...
              if_z      jmp     #SPIRESET                'Set to SQI-Mode
                        jmp     #cog_loop
...
sub_poke
                        ...
                        mov     outa,_COM2_A            '%0000 Befehl $02
                        call    #CLOCK
                        mov     outa,_COM2_B            '%0010
                        call    #CLOCK
                        call    #setadr
'sub_pokeadr_ret         ret
...
'############################ Chip resetten ->SPI-Modus ###################################

SPIRESET                mov     outa,_BUS_INIT
                        mov     dira,_DIR_OUT
                        mov     outa,_COMRESETA         'Kommando $66
                        call    #CLOCK
                        call    #CLOCK
                        mov     outa,DESELECT           'Chip deselect
                        mov     outa,_BUS_INIT
                        mov     dira,_DIR_OUT
                        mov     outa,_COMRESETB         'Kommando $99
                        call    #CLOCK
                        call    #CLOCK
                        mov     outa,DESELECT
                        jmp     #cog_ready
...
_COMRESETA     long %00000000_00000000_00001001_00000000
_COMRESETB     long %00000000_00000000_00001001_00000000

_COM38_A      long %00000000_00000000_00000011_00000000 'Kommando schreiben MSB $38 Write
_COM38_B      long %00000000_00000000_00001000_00000000 'Kommando schreiben LSB

_COM2_A       long %00000000_00000000_00000000_00000000 'Kommando schreiben MSB $02 Write
_COM2_B       long %00000000_00000000_00000010_00000000 'Kommando schreiben LSB

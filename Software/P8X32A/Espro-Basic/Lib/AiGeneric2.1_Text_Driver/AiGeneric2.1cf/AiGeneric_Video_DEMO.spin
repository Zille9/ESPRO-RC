...
PUB mainProgram  | data
  ...
  text.cls
  text.color(lred)
  text.center(string("* * * AIGENERIC V2.1cf * * *"))
  text.out(13)
  text.out(13)
  text.color(SKYBLUE)
  ...
  text.str(string(". - "))
  text.color(purple)
  text.str(string("64c font loader by Baggers",CR))
  text.color(white)
  text.out(13)
  ...
  text.str(string("replacing the .64c file in the dat",CR))
  text.redefine(95,0,0,0,0,0,0,0,255) 'Redefine underscore for below _
  text.str(string("section of ai_driver_002.spin",CR))
  text.color(skyblue)
  text.out(13)
  text.str(string("Want 450+ more fonts?",CR,"jeffledger.googlepages.com/c64fonts.zip"))
